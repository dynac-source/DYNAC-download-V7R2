...
[dyndat.f90](https://github.com/dynac-source/DYNAC-download-V7R2/blob/main/dyndat_V3R3.f90) (source file V3R3) in text format, to be renamed dyndat.f90) is used for GNUPLOT based plots.  
